...
contract TaxToken is Context, IERC20, Ownable {
    ...
    function initialize( address router ) external onlyOwner{
        IRouter2 router2 = IRouter2(router);
        // Create a uniswap pair for this new token
        uniswapV2Pair = IPairFactory(router2.factory())
        .createPair(address(this), router2.weth(), false);
    ...
    function setSwapAndLiquifyEnabled(bool _enabled) public onlyOwner {
     ...
     //to recieve ETH from Router2 when swaping
    ...
    function swapTokensForEth(uint256 tokenAmount) private {
        ...
        path[0] = IRouter2.route(address(this), address(Router2.weth()), false);
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        // add the liquidity
        Router2.addLiquidityETH{value: ethAmount}(
            address(this),
            false,
            tokenAmount,
